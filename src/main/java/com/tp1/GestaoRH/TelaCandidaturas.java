 ...
 * @author spiri
 */
public class TelaCandidaturas extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaCandidaturas.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Status da Candidatura");
        ...
        jButton3.setText("Alterar Status");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaCandidaturas().setVisible(true));
    }
